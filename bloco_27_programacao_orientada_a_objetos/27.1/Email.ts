class Email {
  ...
  constructor(from: string, to: string, subject: string, message: string) {
    ...
    this.subject = subject; // right
    // this._subject = subject; // wrong
  }
...
const soManyA = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
const email = new Email('Ciclano', 'Fulano', soManyA, 'Eae');
